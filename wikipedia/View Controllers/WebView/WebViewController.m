...
@interface WebViewController () <LanguageSelectionDelegate, WMFPullToRefreshViewDelegate>{
...
- (void)setupPullToRefresh{
    ...
    self.pullToRefreshView = [WMFPullToRefreshView defaultIndeterminateProgressViewWithScrollView:self.webView.scrollView delegate:self];
    
    [self.pullToRefreshView pullToRefreshContentView].refreshPromptString = MWLocalizedString(@"article-pull-to-refresh-prompt", nil);
    [self.pullToRefreshView pullToRefreshContentView].refreshRunningString = MWLocalizedString(@"article-pull-to-refresh-is-refreshing", nil);
